...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--task_weight', type=float, default=0.3, help= "task level lgcl weight")
    subparsers.add_argument('--class_weight', type=float, default=0.7, help= "class level lgcl weight")
